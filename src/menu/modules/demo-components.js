export default {
  ...
  children: [
    {
      path: 'demo/components/admin',
      title: '信息管理',
      icon: '',
      children: [
        { path: '/demo/components/user/user', title: '用户', icon: '' },
        { path: '/demo/components/admin/admin', title: '管理员', icon: '' },
        { path: '/demo/components/flight/flight', title: '航班', icon: '' },
        { path: '/demo/components/ticket/ticket', title: '机票', icon: '' },
        { path: '/demo/components/index/index', title: '首页', icon: '' },
        { path: '/demo/components/orders/orders', title: '订单', icon: '' },
        { path: '/demo/components/notice/notice', title: '通知', icon: ''}
      ]
    }
